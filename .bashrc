...
h() {
    $(cat ~/.bash_history | fzf --tac --no-sort)
}
...
source $HOME/.profile
# export PATH=/bin/lscript:/bin/lscript:/home/prithu/bin:/usr/local/bin:/usr/bin:/bin:/usr/local/sbin:/usr/bin/site_perl:/usr/bin/vendor_perl:/usr/bin/core_perl
# export PATH=/bin/lscript:/bin/lscript:/home/prithu/bin:/usr/local/bin:/usr/bin:/bin:/usr/local/sbin:/usr/bin/site_perl:/usr/bin/vendor_perl:/usr/bin/core_perl
